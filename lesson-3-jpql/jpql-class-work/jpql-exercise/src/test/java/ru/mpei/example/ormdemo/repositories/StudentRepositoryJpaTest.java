...
import ru.mpei.example.ormdemo.models.Course;
...
@DisplayName("Jpa repository should ")
@DataJpaTest
...
class StudentRepositoryJpaTest {
    ...
    @DisplayName(" load full student by id")
    @Test
    ...
    @DisplayName(" load collection of student")
    @Test
