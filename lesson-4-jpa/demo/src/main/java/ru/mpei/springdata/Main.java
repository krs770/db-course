...
import ru.mpei.springdata.repository.EmailRepository;
import ru.mpei.springdata.repository.PersonRepository;

import java.util.Objects;
import java.util.stream.Collectors;

import static ru.mpei.springdata.repository.PersonSpecification.emailAddressLike;
import static ru.mpei.springdata.repository.PersonSpecification.nameLike;
